...
try { 
await bob.sendImageAsSticker(M.chat, meme, M, { packname: setting.packname, author: setting.author })
} catch (e) { 
M.reply('gagal membuat stiker, Mencoba Mengirim gambar\owner lupa install ffmpeg:V') 
